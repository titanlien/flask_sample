...
INSERT INTO `tbl_likes` VALUES (16,1,4,1),(25,2,4,0),(17,3,4,0),(20,4,4,1);
...
INSERT INTO `tbl_user` VALUES (4,'titan','fake@gmail.com','pbkdf2:sha1:1000$k1k84E42$d23e37c2e52d5515bdc4e4cee3a195cfb2eb1fff');
...
INSERT INTO `tbl_wish` VALUES (16,'33','',4,'2015-11-17 07:57:20',NULL,0,0),(17,'44','',4,'2015-11-17 20:36:21',NULL,0,0),(20,'55','',4,'2015-11-17 22:10:01',NULL,0,0),(25,'photo','some thing detail',4,'2015-11-19 21:27:16','static/Uploads/17ee5372-b02c-4e20-b4f3-23d5f4d68d0f.png',0,0);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_AddUpdateLikes`(     p_wish_id int,     p_user_id int,     p_like int )
...
-- Dump completed on 2016-02-14 17:32:32
